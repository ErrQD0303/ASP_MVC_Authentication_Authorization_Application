...
public class UserStorageTests
{
    ...
    [Fact]
    public async Task CreateNewUser_SaveItToDatabase_RetrieveItFromDatabase_AndCompareProperties_ResultsInEqualityAsync()
    {
        // Arrange
        var user = new User
        {
        ...
        var userRepository = new DatabaseUserRepository(dbContext);
    ...
    [Fact]
    public async Task CreateNewUserWithInvalidUserName_ThrowsArgumentExceptionAsync_DatabaseVersion()
    {
        // Arrange
        var user = new User
        {
